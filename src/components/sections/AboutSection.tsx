      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              I am dedicated to expanding my expertise in <span className="text-primary font-semibold">AI Automation</span>, applying my testing knowledge to real-world scenarios, and contributing to software excellence with commitment and enthusiasm.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
